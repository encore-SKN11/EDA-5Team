...
Kaggle - **TMDB 5000 Movie Dataset** : TMDB에서 제공하는 영화 데이터

<br/>

## **데이터 구성**

- **tmdb_5000_movies.csv** : 영화의 기본 정보를 포함합니다. 예를 들어, **제작비, 수익, 장르, 평점 등**이 포함되어 있습니다.
- **tmdb_5000_credits.csv** : 영화의 크레딧 정보를 포함합니다. 예를 들어, **감독과 배우 정보**가 포함되어 있습니다.
